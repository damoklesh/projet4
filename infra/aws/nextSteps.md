...
VPC, subnets, NAT gateways, ALB, ECS, ECR, RDS, EFS, IAM roles, CloudWatch logs, Secrets Manager
...
This setup creates paid resources, especially NAT gateways, RDS, EFS, and ALB.
terraform destroy
18.
